...
from app.infrastructure.repositories.app_config_repository import (
...
class SqlAlchemyUnitOfWork(AbstractUnitOfWork):
    ...
    async def __aenter__(self):
        ...
        self.app_config_repo = SqlAlchemyAppConfigRepository(self.session)
        return self
